...
class Classroom(models.Model):
    CLASS_CHOICES = (
        ...
        # ('Gymnastics Ages 6-12', 'Level 1&2'),

        ('9 Boys Section 1', 'Class 9'),
        ('10 Boys Section 1', 'Class 10'),
        ('10 Boys Section 2', 'Class 10'),
        ('11 Boys Section 1', 'Class 11'),
        ('11 Boys Section 2', 'Class 11'),
        ('12 Boys Section 1', 'Class 12'),
        ('12 Boys Section 2', 'Class 12'),
    )
    CLASS_TYPE = (
        # ('Parkour', 'Parkour'),
