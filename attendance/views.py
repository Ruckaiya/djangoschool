...
class ClassroomListView(ListView):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        class9_classes = Classroom.objects.filter(type='Class 9')
        class10_classes = Classroom.objects.filter(type='Class 10')
        class11_classes = Classroom.objects.filter(type='Class 11')
        class12_classes = Classroom.objects.filter(type='Class 12')

        all_classes = [class9_classes, class10_classes, class11_classes, class12_classes]
